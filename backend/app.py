...
def add_transaction():
    ...
    # Determine fromWhom and toWhom
    transaction_type = data.get("type").lower()
    from_whom = data.get("fromWhom", "")
    to_whom = data.get("toWhom", "")

    if transaction_type == "borrow":
        # Borrowed from someone → toWhom empty
        to_whom = ""
    elif transaction_type == "return":
        # Returned to someone → fromWhom empty
        from_whom = ""
    elif transaction_type == "loan":
        # Loan given to someone → fromWhom empty
        from_whom = ""
...
#         "id": str(uuid.uuid4()),
#         "type": data.get("type"),
#         "amount": Decimal(str(data.get("amount"))),  # keep Decimal
#         "person": data.get("person"),  # NEW field
#         "description": data.get("description", ""),
#         "date": data.get("date"),
#     }
